...
if __name__ == '__main__':
    ...
    task_suite = ["libero_object", "libero_spatial", "libero_10"] #['libero_goal', 'libero_90']#["libero_object", "libero_spatial", "libero_10"]
    ...
    csv_file = open(sv_dir + '/bc_decoder.csv', 'w', newline='')
    ...
    for task in task_suite:
        ...
        for diff in diff_steps:
            ...
            for obs in obs_seq:
                ...
                for trans_n in trans_n_layer:

                    writer.writerow([f'{task}_diff{diff}_obs{obs}_layer{trans_n}'])
